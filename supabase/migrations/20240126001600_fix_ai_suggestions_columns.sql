-- Drop and recreate ai_suggestions table to match schema.ts exactly
...
BEGIN
  ...
  IF user_role = 'customer' THEN
    ...
    -- Create AI suggestion request with placeholder response
    INSERT INTO ai_suggestions (
      ...
      NEW.ticket_id,
      'Processing...', -- Temporary value since it's NOT NULL
...
INSERT INTO ticket_messages (
    ...
    'Testing trigger with schema-aligned table',
    'user_message'
) RETURNING *;
